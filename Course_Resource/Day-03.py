...
'''
In Python, a class is a blueprint for creating objects. It acts as a template that defines,
the properties (attributes) and behaviors (methods) that objects of that class will have. 
Think of a class as a cookie cutter, and objects as the cookies you create with that cutter.
...
'''
An object is an instance of a class. It's a concrete entity based on a class, 
and it has its own unique state and behavior. You can create multiple objects from the same class, each with its own distinct attributes and methods.
...
'''
This is just a basic introduction to classes and objects in Python. They're fundamental concepts in object-oriented programming, 
and understanding them well will open up a lot of possibilities for organizing and managing your code.
'''
...
'''
The `__init__` method is a special method in Python classes, also known as the constructor. It's called automatically whenever a new object of the class is created. 
